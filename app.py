        ...
        <div id="login-screen">
            <div id="login-box">
                ...
                <div class="google-btn-wrapper">
                    <div id="g_id_onload"
                         data-client_id="from fastapi import FastAPI, WebSocket, WebSocketDisconnect
from fastapi.responses import HTMLResponse
from pydantic import BaseModel
import json
import sqlite3
...
<body class="theme-dark">
    ...
    <script>
        ...
        console.log("currentUser on load:", currentUser);
        ...
        async function initializeUserSession(username) {
            console.log("initializeUserSession called with:", username);
